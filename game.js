                                ...
                                me.say('Да так, ни о чем…{w} Наслаждаюсь походом.').next(function() {
                                    me.narration('Съязвил я.').next(function() {
                                        sl.say('Ясно.').next(function() {
                                            ...
                                            me.narration('Единственным, что мне хотелось сейчас, было поскорее улечься в постель и заснуть, но вместо этого я все больше пропитывался дымом от костра и пустой болтовней окружающих.').next(function() {
                                            me.narration('Я принялся наблюдать за пионерами.{w} Все веселились, смеялись, в общем, наслаждались теплым летним вечером.').next(function() {
...
function jealousy_dv() {
    ...
    me.narration('Я аккуратно подошел поближе, пытаясь понять, что происходит.').next(function(){
        ...
        me.narration('Я старался, как мог, не привлекать внимания и делать вид, что просто стою рядом, не интересуясь их разговором.').next(function() {
        ...
        me.narration('Лена злилась.{w} Одно это уже было в высшей степени странно, даже учитывая то, что я не знал предмета спора.').next(function() {
